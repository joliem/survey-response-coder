...
def code_responses_demo(
    ...
    for i, text in enumerate(responses):
        ...
        if use_precomputed:
            ...
            translated = _stored if _stored in taxonomy_name_set else None
            if translated is None and pd.notna(_stored):
                targets = source_targets.get(_stored, [])
        ...
        if multi_theme:
            ...
            if row_precomputed and has_secondary:
                ...
                translated_secondary = secondary if secondary in taxonomy_name_set else None
                if translated_secondary is None and pd.notna(secondary):
                    targets = source_targets.get(secondary, [])
