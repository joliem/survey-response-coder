...
_WRAP_FN = """\
def _format_category_label(text, max_chars=32):
...
def generate_notebook(
    ...
    supplemental_alpha = 0.05 / max(1, supplemental_test_count)
    ...
    if include_valence and "valence_score" in coded_df.columns:
        ...
        cells.append(_md(
            ...
            f"The Bonferroni-adjusted threshold is α = {supplemental_alpha:.3g} (familywise α = 0.05 "
            f"across {supplemental_test_count} supplemental test(s))."
        ))
        cells.append(_code(
