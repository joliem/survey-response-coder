        ...
        for cov in covariate_cols:
            ...
            if cov_type == "categorical":
                ...
                cells.append(_code(
                    ...
                    f"_cat_labels = [_wrap_label(str(c), width=28) for c in _pct.index]\n"
                    ...
                    f"        name=theme, y=_cat_labels, x=_pct[theme].tolist(), orientation='h',\n"
                    f"        marker_color=THEME_COLORS.get(theme, palette[_ri % len(palette)]),\n"
                    f"    ))\n"
                    f"fig.update_layout(\n"
                    f"    barmode='stack', title='Theme Mix by {cov}',\n"
                    f"    xaxis={{'title': '% of responses', 'range': [0, 101]}},\n"
                    f"    yaxis={{'title': '{cov}', 'automargin': True, 'autorange': 'reversed'}},\n"
                    f"    legend={{'title': 'Theme', 'traceorder': 'reversed'}}, height=_height,\n"
                    f"    margin={{'l': 10, 'r': 10, 't': 60, 'b': 40}},\n"
                    f")\n"
                    f"_style(fig).show()\n\n"
