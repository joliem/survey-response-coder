        ...
        if cov_type == "categorical":
            ...
            if n_cov > 1:
                ...
                st.caption(
                    ...
                    f"Minimum expected count = {stats['expected_min']}; {stats['expected_below_5_pct']}% are below 5. "
                    "When Pearson assumptions fail, the reported p-value comes from label permutations instead. "
        ...
        with st.expander("Statistical Test: Emotion Label × Primary Theme"):
            ...
            if len(_emo_clean) < 10 or _emo_clean["emotion"].nunique() < 2:
                ...
                st.caption(
                    ...
                    f"Minimum expected count = {_emo_stats['expected_min']}; "
                    f"{_emo_stats['expected_below_5_pct']}% are below 5. When Pearson assumptions fail, "
                    "the displayed p-value is obtained by permutation. "
                    "**Cramér's V** measures effect size on a 0–1 scale: "
                    "< 0.1 = negligible, 0.1–0.3 = moderate, > 0.3 = strong. "
