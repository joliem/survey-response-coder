        ...
        if cov_type == "categorical":
            ...
            if stats["significant"]:
                ...
                st.success(
                    ...
                    f"(p {_p_display if _p_display.startswith('<') else '= ' + _p_display}). "
                    f"Bias-corrected Cramér's V = {stats['cramers_v']} — {strength} effect."
                )
            else:
                st.info(f"No statistically significant association found (p = {_p_display}).")
            ...
            if n_cov > 1:
                ...
                st.caption(
                    ...
                    f"significantly across groups of the covariate. **Method: {stats['method']}.** "
                ...
                if stats is None:
                    ...
                    if stats["significant"]:
                        ...
                        st.info(
                            ...
                            f"(p = {format_p_value(stats['p_value'])})."
                        )
                    st.caption(
